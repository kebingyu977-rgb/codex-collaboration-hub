...
- Update (2026-09-24): Added two non-routine, non-overlapping responsibilities and rebalanced to 17 records totaling 100%: special integrated-marketing project planning and cross-party coordination for initiatives such as France (7%), plus cross-campaign online-to-offline conversion-chain construction and pilots (5%). Routine activity targets only configure against this shared mechanism; they do not replace its long-term construction work.
